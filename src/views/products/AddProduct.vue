    ...
    <ion-footer class="ion-padding-start ion-padding-end">
      <ion-toolbar color="tranparency">
        <stack row :equal="true" gap="10px">
          <ion-button :disabled="!doc.name"  @click="onDelete" color="danger" expand="full" shape="round">{{ t("Delete")}}</ion-button>
          <ion-button @click="onSave" color="success" expand="full" shape="round">{{ t("Save")}}</ion-button>
        </stack>
      </ion-toolbar>
    </ion-footer>
  </ion-page>
