<template>
    <div class="fix-container">
        ...
        <ion-grid>
                    ...
                    <ion-card>
                        <ion-card-content>
                            ...
                            <stack row equal>
                                ...
                                <ion-label>{{ dayjs(data?.shift_doc.creation).format("DD/MM/YYYY hh:mm A")
                                    }}</ion-label>
                            </stack>
                            <stack row equal>
                        ...
                        <ion-card-content>
                            ...
                            <stack>
                                <stack row equal>
                                    ...
                                    <ion-label>
                                        <ComCurrency :value="data?.shift_doc.total_opening_amount" />
                                    </ion-label>

                                    <ion-label><strong>{{ t("Total Closes Amount") }}</strong></ion-label>
                                    <ion-label>
                                        <ComCurrency :value="data?.shift_doc.total_close_amount" />
                                    </ion-label>
                                ...
                                <stack row equal>
                                    ...
                                    <ion-label>
                                        <ComCurrency :value="data?.shift_doc.total_system_close_amount" />
                                    </ion-label>

                                    <ion-label><strong>{{ t("Total Difference Amount") }}</strong></ion-label>
                                    <ion-label>
                                        <ComCurrency :value="data?.shift_doc.total_different_amount" />
                                    </ion-label>
            ...
            <ion-row>
                <ion-col>
                    <ComStoreRevenueSummary v-if="data?.shift_doc.name" :working_day="data?.shift_doc.working_day" />
                </ion-col>
            </ion-row>
            <ion-row>
                <ion-col>
