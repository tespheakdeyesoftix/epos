<template>
    <ion-page>
        <AppBar>{{ t("Store List") }}
<template #end>
<ion-button class="ion-hide-md-down" shape="round" @click="onReloadData" v-tooltip="`${t('Refresh Data')}`">
...
<div class="ion-padding">
   ...
   <ComCardKPI mainClass="bg-yellow-500"  label="MTD Revenue"
      :value="getTotal('mtd_revenue')" :isCurrency="true"/>
      <ComCardKPI mainClass="bg-green-500" label="YTD Revenue"
      :value="getTotal('ytd_revenue')" :isCurrency="true" />
