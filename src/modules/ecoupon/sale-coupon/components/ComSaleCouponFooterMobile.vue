...
<ion-footer >
    ...
    <ion-card @click="onViewSelectedSaleProduct" color="success" class="ion-no-margin ion-no-padding" button>
        <ion-card-content>
            ...
            <ion-grid class="ion-no-padding">
                ...
                <ion-row >
                    ...
                    <ion-col size="3">
                        <ion-text class="text-3xl"><ComCurrency :value="grandTotal"/></ion-text>
